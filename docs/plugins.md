...
|---|---|---|---|
| **Compute** | tool-provider | answers a synchronous call — an agent-callable tool | [`cash-forecast`](../examples/tool-providers/cash-forecast/README.md) · [`slugify`](../templates/slugify/README.md) |
...
- [`../examples/README.md`](../examples/README.md) — the published
  samples index; `examples/tool-providers/cash-forecast/` is the
  richest single reference (procedure, skills and training beside its
  sidecar), and `templates/` holds the shipped templates' own source
  mirrors.
