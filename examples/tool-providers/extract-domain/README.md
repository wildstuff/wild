...
This tree is unpacked from [`../../../assets/marketplace/templates/extract-domain-0.1.4.tar.gz`](../../../assets/marketplace/templates/extract-domain-0.1.4.tar.gz), the signed artefact an
