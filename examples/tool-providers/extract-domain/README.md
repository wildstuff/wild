# `extract-domain` — GENERATED, do not edit

This tree is unpacked from [`../../../assets/marketplace/templates/extract-domain-0.1.3.tar.gz`](../../../assets/marketplace/templates/extract-domain-0.1.3.tar.gz), the signed artefact an
